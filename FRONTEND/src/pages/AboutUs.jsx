    ...
    <>
      ...
      <div className="bg-black opacity-70 p-4 mt-4 flex flex-col items-center">
        ...
        <details className="text-center p-3 text-sm md:text-base leading-relaxed text-white max-w-xl mb-30">
          ...
          <p className="mt-3">
            HomeX is your smart, no-stress way to find a house. Whether you're
            relocating or searching locally, we help you discover real listings
            in real time — with zero agent pressure.
          </p>
          <p className="mt-3">
            Browse rentals freely, filter by area or price, and see clear photos
            and details. When you're ready, you can unlock contact info and map
            directions with a small fee — no commissions, no calls, just
            control.
          </p>
